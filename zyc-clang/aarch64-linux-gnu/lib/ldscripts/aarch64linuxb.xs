...
OUTPUT_ARCH(aarch64)
ENTRY(_start)
SEARCH_DIR("/__w/clang-builder/clang-builder/clang-15/install/aarch64-linux-gnu/lib64"); SEARCH_DIR("/__w/clang-builder/clang-builder/clang-15/install/aarch64-linux-gnu/lib");
SECTIONS
{
